...
<head>
  ...
  <title>SuciRias | Status Pembayaran</title>
            ...
            <section class="content">
              ...
              <div class="card">
                <div class="card-header">
                  <h3 class="card-title">Ulasan Testimoni</h3>
                        ...
                        <div class="col-12 col-sm-4">
                          <div class="info-box bg-light">
                            <div class="info-box-content">
                              <span class="info-box-text text-center text-muted">Jumlah Ulasan</span>
                        ...
                        <div class="col-12">
                          ...
                          <div class="post">
                            <div class="user-block mt-3">
                              ...
                              <span class="description">Harga Terjangkau - 12-02-2024 02:45 PM</span>
                            </div>
                            <!-- /.user-block -->
                            <p>
