  ...
  <div class="wrapper">
    ...
    <aside class="main-sidebar sidebar-light-pink elevation-4">
      ...
      <a href="../index2.html" class="brand-link">
        <img src="<?= base_url('assets/admin/'); ?>..\..\admin\dist\img\logo\logo black.svg" alt="AdminLTE Logo" class="brand-image" style="opacity: .8">
              ...
              <div class="col-md-4 col-12">
                <div class="info-box shadow">
                  ...
                  <div class="info-box-content">
                    <a href=""><span class="info-box-number">Konfirmasi Pesanan</span></a>
                  </div>
                  <!-- /.info-box-content -->
                </div>
                <!-- /.info-box -->
